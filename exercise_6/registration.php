...
$sql=" INSERT INTO `users` ( `username`, `password`, `first`, `last`, `city`, `dept`, `pin`) VALUES ( '$username', '$password', '$first', '$last', '$city', '$dept', '$zip')";
...
<form action="/exercise_6/registration.php" method="post">
